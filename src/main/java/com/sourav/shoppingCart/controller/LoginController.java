...
import com.sourav.shoppingCart.jwtConfiguration.AuthorizationManager;
import com.sourav.shoppingCart.jwtConfiguration.JwtTokenProvider;
import com.sourav.shoppingCart.jwtConfiguration.UserPrincipal;
import com.sourav.shoppingCart.controller.RequestPojo.ApiResponse;
import com.sourav.shoppingCart.dto.LoginRequest;
...
public class LoginController {
	...
	public ResponseEntity<?> userLogin(@RequestBody LoginRequest loginRequest) {
		...
		try {
        	...
        	Authentication authentication =  aMan.authenticate(new UsernamePasswordAuthenticationToken(loginRequest.getMobile(), loginRequest.getPassword()) );
